...
{if !$registrationDisabled}
    <div id="registration" style="padding-bottom:0px">
        <form method="post" class="using-password-strength" action="{$smarty.server.PHP_SELF}" role="form" name="orderfrm" id="frmCheckout">
                        ...
                        <div id="containerPassword" class="row{if $remote_auth_prelinked && $securityquestions} hidden{/if}">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group prepend-icon">
                                    ...
                                    <input style="background-color: #212235;border: none;height: 36px;width: 90%;margin-left:10px;outline:none;color:#fff;" type="password" name="password" id="inputNewPassword1" data-error-threshold="{$pwStrengthErrorThreshold}" data-warning-threshold="{$pwStrengthWarningThreshold}" class="field" placeholder="{lang key='clientareapassword'}" autocomplete="off"{if $remote_auth_prelinked} value="{$password}"{/if}>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group prepend-icon">
                                    ...
                                    <input style="background-color: #212235;border: none;height: 36px;width: 90%;margin-left:10px;outline:none;color:#fff;" type="password" name="password2" id="inputNewPassword2" class="field" placeholder="{lang key='clientareaconfirmpassword'}" autocomplete="off"{if $remote_auth_prelinked} value="{$password}"{/if}>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
            ...
            <p class="text-center">
                <input class="theme-btn --fill-primary{$captcha->getButtonClass($captchaForm)}" type="submit" value="{lang key='clientregistertitle'}"/>
            </p>
        </form>
    </div>
{/if}
