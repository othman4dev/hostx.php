        ...
        <div class="container">
          ...
          <div class="footer-list-group">
            <div style="width:40%; display:flex;flex-direction:column;" >
              <div class="icon" style="width:150px;height:100px;background-color:transparent;display:flex;align-items:center;justify-content:center;">
                <img src="{$WEB_ROOT}/templates/hostx_whmcs/images/icons/CLASSRDP.png" style="height:100%"/>
              </div>
