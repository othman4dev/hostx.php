<form role="form" method="post" action="{routePath('knowledgebase-search')}" class="mb-4">
    <div class="input-group input-group-lg kb-search">
        ...
        <div class="input-group-append">
            <button type="submit" id="btnKnowledgebaseSearch" class="btn --fill-primary btn-input-padded-responsive">
                {lang key='search'}
            </button>
        </div>
    </div>
...
<a href="javascript:history.go(-1)" class="theme-btn --fill-primary --btn-size-sm px-4">
