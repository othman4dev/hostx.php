    ...
    <div class="container">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-xl-7 text-xl-left text-center">
          <!-- title-1 & para-1 -->
            <h1 class="title-1 text-uppercase mb-4 mx-xl-0 mx-auto" style="font-size: 1.5rem;">VPS/RDP Hosting: High performance, Reliability, and Scalability for Your Business!</h1>
